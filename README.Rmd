...
*Note: Calibration standards are passed as parameters to `step_sec_conventional_cal()`, not as a separate data input. MALS provides absolute MW without requiring calibration standards.*
