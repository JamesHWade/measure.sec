...
adequately before analyzing samples. This guide shows you how to:
...
Resolution measures separation between adjacent peaks. Use this to
verify critical pairs are adequately separated.
...
Plate count measures column efficiency. Calculate this for your main
peak.
...
Monitoring column performance helps you know when to replace a column
before it affects your results.
...
#> Column still within specifications through end of monitoring period
```
