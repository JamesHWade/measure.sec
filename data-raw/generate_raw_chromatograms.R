...
generate_raw_unknowns <- function() {
	...
	unknowns <- tribble(
		...
		85000,
		2.05,
		"Broad distribution PMMA-like",
		"Unknown-B",
		125000,
		95000,
		165000,
		1.32,
		"Medium dispersity PS-like",
		"Unknown-C",
		82000,
		75000,
		92000,
		1.09,
		"Narrow distribution reference",
		"Unknown-Bimodal",
		NA,
		NA,
		NA,
		NA,
		"Bimodal mixture (50K + 200K)",
		"Unknown-HMW",
		1500000,
		1200000,
		1900000,
		1.25,
		"Very high MW with aggregates",
		"Unknown-LMW",
		3500,
		2800,
		4500,
		1.25,
		"Low MW oligomer region"
	)
...
generate_raw_multidetector <- function() {
	...
	samples <- tribble(
		...
		0.185,
		1.2,
		"Narrow PS for delay determination",
		"Sample-1",
		75000,
		1.85,
		0.185,
		1.1,
		"PS sample with UV absorption",
		"Sample-2",
		150000,
		2.1,
		0.085,
