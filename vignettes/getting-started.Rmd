...
flowchart TD
    ...
    C --> D[step_sec_ri / step_sec_uv<br>Detector processing]
    D --> E{Calibration<br>method?}
    E -->|Standards| F[step_sec_conventional_cal<br>Polynomial fit]
    E -->|Absolute| G[step_sec_mals<br>Light scattering]
    F --> H[step_sec_mw_averages<br>Calculate Mn, Mw, Mz]
    G --> H
    H --> I[Results<br>MW averages, distributions, plots]
