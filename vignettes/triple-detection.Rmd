...
flowchart TB
    ...
    subgraph Process["📊 Signal Processing"]
        ...
        C3[step_sec_mals<br>Zimm/Debye fit]
        C4[step_sec_viscometer<br>Intrinsic viscosity]
    end

    subgraph Calculate["🔬 Calculations"]
        D1[Concentration<br>from RI or UV]
        D2[Absolute MW<br>from MALS]
        D3[Rg from<br>angular dependence]
        D4[Intrinsic viscosity<br>from viscometer]
    end
